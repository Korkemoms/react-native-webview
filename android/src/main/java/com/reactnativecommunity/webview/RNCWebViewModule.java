...
public class RNCWebViewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  @VisibleForTesting
  public static final String REACT_CLASS = "RNCWebViewModule";

  public RNCWebViewModule(ReactApplicationContext context) {
    super(context);
  ...
  // NB: parts of the permission management are adapted, with significant
  // modification, from
  ...
  public boolean grantFileDownloaderPermissions() {
    ...
    if (!result) {
      ...
      activity.requestPermissions(new String[] { Manifest.permission.WRITE_EXTERNAL_STORAGE },
          FILE_DOWNLOAD_PERMISSION_REQUEST, webviewFileDownloaderPermissionListener);
    }
    return result;
  }
